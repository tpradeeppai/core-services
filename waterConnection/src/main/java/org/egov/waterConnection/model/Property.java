...
import org.egov.waterConnection.model.Institution;
import org.egov.waterConnection.model.OwnerInfo;
import org.egov.waterConnection.model.PropertyInfo;
import org.egov.waterConnection.model.Unit;
...
@Size(min=1,max=64)   public String getAcknowldgementNumber() {
    return acknowldgementNumber;
  }
...
@Size(max=64)   public String getPropertyType() {
    return propertyType;
  }
...
@Size(max=64)   public String getOwnershipCategory() {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(acknowldgementNumber, propertyType, ownershipCategory, owners, institution, creationReason, noOfFloors, landArea, source, channel, documents, unit, additionalDetails, super.hashCode());
  }
