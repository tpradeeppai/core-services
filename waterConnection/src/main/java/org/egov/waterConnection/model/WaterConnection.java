...
@Size(min=2,max=64)   public String getWaterSource() {
    return waterSource;
  }
...
@Size(min=2,max=64)   public String getMeterId() {
    return meterId;
  }
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(connectionCategory, rainWaterHarvesting, connectionType, waterSource, meterId, meterInstallationDate, documents, super.hashCode());
  }
