...
//
//public class WaterSearchQueryBuilder {
//	
//
//	private static final String INNER_JOIN_STRING = "INNER JOIN";
//	private static final String LEFT_OUTER_JOIN_STRING = "LEFT OUTER JOIN";
//
//	private static final String QUERY = "SELECT * from water_service_connection"+INNER_JOIN_STRING+"SELECT pt.*,ptdl.*,address.*,owner.*,doc.*,unit.*,insti.*,"
...
//	}
//
//	public String getPropertySearchQuery(WaterConnectionSearchCriteria criteria, List<Object> preparedStmtList) {
//
//		StringBuilder builder = new StringBuilder(QUERY);
//
//		Set<String> statuses = new HashSet<>();
//		String status=
//		criteria.getStatus().forEach(statusEnum -> {
