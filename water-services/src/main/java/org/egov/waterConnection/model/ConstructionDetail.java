...
@Size(min=1,max=64)   public String getConstructionType() {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, totalUnitArea, builtUpArea, carpetArea, superBuiltUpArea, constructionType, constructionDate, dimensions, auditDetails, additionalDetails);
  }
