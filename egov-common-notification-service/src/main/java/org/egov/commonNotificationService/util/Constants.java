package org.egov.commonNotificationService.util;
...
public class Constants {
    ...
    public static final String NOTIFICATION_MODULE = "Workflow";
    ...
    public static final String COMMON_NOTIFICATION_FILE = "notification";

    public static final String PT_FILE = "notification_PT";
    ...
    public static  final  String MDMSLIST = "TYPE";
    ...
    public static  final  String BASEDETAILS_KEY = "BASEDETAILS";

    public static  final  String OWNERS_KEY = "OWNERS";

    public static  final  String OWNERNAME_KEY = "OWNER NAME";

    public static  final  String MOBILENUMBER_KEY = "MOBILE NUMBER";

    public  static  final  String REQUESTINFO_PATH = "$.RequestInfo";

    public  static  final  String TENANTID_PATH = "$..tenantId";

    public static final  String TENANT_REGEX = "^(?!=.*\\d)([a-z]+)\\.([a-z]+)";

    public static  final  String PLACEHOLDER_REGEX = "\\<.*?\\>";

    public static  final  String MESSAGETEMPLATE_PATH = "$..messages[?(@.code==\"{}\")].message";
    ...
    public static final String ACTION_PROPERTY_SAVE  = "save-pt-property";

    public static final String ACTION_PROPERTY_UPDATE  = "update-pt-property";
